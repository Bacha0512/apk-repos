.class public Lcom/weirdvoice/ui/prefs/hc/PrefsLoaderFragment;
...
.method private getPreferenceType()I
    ...
    .prologue
    .line 46
    invoke-virtual {p0}, Lcom/weirdvoice/ui/prefs/hc/PrefsLoaderFragment;->getArguments()Landroid/os/Bundle;
...
.method private setPreferenceScreenType(Ljava/lang/Class;Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, p2}, Lcom/weirdvoice/ui/prefs/hc/PrefsLoaderFragment;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
...
.method protected getDefaultFieldSummary(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lcom/weirdvoice/ui/prefs/hc/PrefsLoaderFragment;->getString(I)Ljava/lang/String;
    :try_end_0
...
.method public hidePreference(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .prologue
    .line 61
    invoke-virtual {p0}, Lcom/weirdvoice/ui/prefs/hc/PrefsLoaderFragment;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 53
    invoke-direct {p0}, Lcom/weirdvoice/ui/prefs/hc/PrefsLoaderFragment;->getPreferenceType()I

    move-result v0

    .line 54
    .local v0, "type":I
    invoke-static {v0}, Lcom/weirdvoice/ui/prefs/PrefsLogic;->getXmlResourceForType(I)I

    move-result v1

    invoke-virtual {p0, v1}, Lcom/weirdvoice/ui/prefs/hc/PrefsLoaderFragment;->addPreferencesFromResource(I)V

    .line 55
    invoke-virtual {p0}, Lcom/weirdvoice/ui/prefs/hc/PrefsLoaderFragment;->getActivity()Landroid/app/Activity;
    ...
    invoke-static {v1, p0, v2}, Lcom/weirdvoice/ui/prefs/PrefsLogic;->afterBuildPrefsForType(Landroid/content/Context;Lcom/weirdvoice/ui/prefs/IPreferenceHelper;I)V
...
.method public setPreferenceScreenSub(Ljava/lang/String;Ljava/lang/Class;Ljava/lang/Class;I)V
    ...
    invoke-direct {p0, p3, p1, p4}, Lcom/weirdvoice/ui/prefs/hc/PrefsLoaderFragment;->setPreferenceScreenType(Ljava/lang/Class;Ljava/lang/String;I)V
...
.method public setPreferenceScreenType(Ljava/lang/String;I)V
    ...
    invoke-direct {p0, v0, p1, p2}, Lcom/weirdvoice/ui/prefs/hc/PrefsLoaderFragment;->setPreferenceScreenType(Ljava/lang/Class;Ljava/lang/String;I)V
...
.method public setStringFieldSummary(Ljava/lang/String;)V
    ...
    .line 110
    invoke-virtual {p0, p1}, Lcom/weirdvoice/ui/prefs/hc/PrefsLoaderFragment;->getDefaultFieldSummary(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    .line 112
    :cond_0
    invoke-virtual {p0, v1, v3}, Lcom/weirdvoice/ui/prefs/hc/PrefsLoaderFragment;->setPreferenceSummary(Landroid/preference/Preference;Ljava/lang/CharSequence;)V
