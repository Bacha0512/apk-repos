.class public Lcom/weirdvoice/plugins/telephony/CallHandler;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/weirdvoice/plugins/telephony/CallHandler;->sPhoneAppBmp:Landroid/graphics/Bitmap;

    .line 51
    const/4 v0, 0x0

    sput-boolean v0, Lcom/weirdvoice/plugins/telephony/CallHandler;->sPhoneAppInfoLoaded:Z
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 55
    const-string v9, "com.weirdvoice.phone.action.HANDLE_CALL"
    ...
    invoke-static {p1}, Lcom/weirdvoice/utils/PhoneCapabilityTester;->isPhone(Landroid/content/Context;)Z
    ...
    :cond_0
    sget-boolean v9, Lcom/weirdvoice/plugins/telephony/CallHandler;->sPhoneAppInfoLoaded:Z

    if-nez v9, :cond_3

    .line 70
    invoke-static {p1}, Lcom/weirdvoice/utils/PhoneCapabilityTester;->resolveActivitiesForPriviledgedCall(Landroid/content/Context;)Ljava/util/List;
    ...
    :cond_2
    :goto_0
    sput-boolean v12, Lcom/weirdvoice/plugins/telephony/CallHandler;->sPhoneAppInfoLoaded:Z

    .line 92
    .end local v1    # "callers":Ljava/util/List;, "Ljava/util/List<Landroid/content/pm/ResolveInfo;>;"
    :cond_3
    invoke-virtual {p0, v12}, Lcom/weirdvoice/plugins/telephony/CallHandler;->getResultExtras(Z)Landroid/os/Bundle;
    ...
    .line 97
    sget-object v9, Lcom/weirdvoice/plugins/telephony/CallHandler;->sPhoneAppBmp:Landroid/graphics/Bitmap;
    ...
    sget-object v10, Lcom/weirdvoice/plugins/telephony/CallHandler;->sPhoneAppBmp:Landroid/graphics/Bitmap;
    ...
    sput-object v9, Lcom/weirdvoice/plugins/telephony/CallHandler;->sPhoneAppBmp:Landroid/graphics/Bitmap;
    :try_end_0
    ...
    invoke-static {v9, v10, v2}, Lcom/weirdvoice/utils/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
