...
.field private t:Landroid/support/v7/widget/o;
...
.method constructor <init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/b;)V
    ...
    invoke-direct {p0, p1, p2, p3}, Landroid/support/v7/app/d;-><init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/b;)V
...
.method private a(Landroid/support/v7/view/menu/h;Z)V
    ...
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->t:Landroid/support/v7/widget/o;
    ...
    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->t:Landroid/support/v7/widget/o;

    invoke-interface {v1}, Landroid/support/v7/widget/o;->f()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/o;->h()Z
...
.method private b(Landroid/support/v7/app/AppCompatDelegateImplV9$PanelFeatureState;Landroid/view/KeyEvent;)Z
    ...
    iget-object v4, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->t:Landroid/support/v7/widget/o;

    if-eqz v4, :cond_6

    iget-object v4, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->t:Landroid/support/v7/widget/o;

    invoke-interface {v4}, Landroid/support/v7/widget/o;->j()V
    ...
    instance-of v4, v4, Landroid/support/v7/app/l;
    ...
    invoke-interface {v4, v5, v6}, Landroid/support/v7/widget/o;->a(Landroid/view/Menu;Landroid/support/v7/view/menu/o$a;)V
    ...
    invoke-interface {v0, v7, v1}, Landroid/support/v7/widget/o;->a(Landroid/view/Menu;Landroid/support/v7/view/menu/o$a;)V
...
.method private x()Landroid/view/ViewGroup;
    ...
    iput-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->t:Landroid/support/v7/widget/o;
    ...
    invoke-interface {v1, v2}, Landroid/support/v7/widget/o;->setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v1, v6}, Landroid/support/v7/widget/o;->a(I)V
    ...
    invoke-interface {v1, v2}, Landroid/support/v7/widget/o;->a(I)V
    ...
    invoke-interface {v0, v2}, Landroid/support/v7/widget/t;->setOnFitSystemWindowsListener(Landroid/support/v7/widget/t$a;)V
    ...
    :cond_e
    invoke-static {v2}, Landroid/support/v7/widget/ar;->b(Landroid/view/View;)V
...
.method a(Landroid/support/v7/view/b$a;)Landroid/support/v7/view/b;
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->e:Landroid/support/v7/app/b;
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/app/b;->a(Landroid/support/v7/view/b;)V
...
.method public a(Landroid/support/v7/widget/Toolbar;)V
    ...
    invoke-virtual {v1}, Landroid/support/v7/app/l;->j()Landroid/view/Window$Callback;
...
.method public b(Landroid/support/v7/view/b$a;)Landroid/support/v7/view/b;
    ...
    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->e:Landroid/support/v7/app/b;
    ...
    invoke-interface {v1, v2}, Landroid/support/v7/app/b;->a(Landroid/support/v7/view/b;)V
...
.method public b(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :goto_0
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->K:Landroid/support/v7/app/j;
    ...
    iput-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV9;->K:Landroid/support/v7/app/j;
    ...
    invoke-virtual/range {v0 .. v8}, Landroid/support/v7/app/j;->a(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
...
.method b(Landroid/support/v7/view/menu/h;)V
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/o;->k()V
...
.method public g()V
    ...
    :cond_0
    invoke-super {p0}, Landroid/support/v7/app/d;->g()V
