...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    invoke-static {p1, p2, v0, p3, v7}, Landroid/support/v7/widget/an;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/an;
    ...
    invoke-static {v2, p2, v5, p3, v7}, Landroid/support/v7/widget/an;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/an;
    ...
    invoke-virtual {v2, v5, v6}, Landroid/support/v7/widget/an;->f(II)I
    ...
    invoke-virtual {v2, v5}, Landroid/support/v7/widget/an;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v4, v5}, Landroid/support/v7/widget/an;->d(I)Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v0, v5}, Landroid/support/v7/widget/AppCompatSpinner$b;->a(Ljava/lang/CharSequence;)V

    invoke-virtual {v2}, Landroid/support/v7/widget/an;->a()V
    ...
    iput-object v2, p0, Landroid/support/v7/widget/AppCompatSpinner;->g:Landroid/support/v7/widget/u;

    :cond_2
    sget v0, Landroid/support/v7/a/a$j;->Spinner_android_entries:I

    invoke-virtual {v4, v0}, Landroid/support/v7/widget/an;->f(I)[Ljava/lang/CharSequence;
    ...
    invoke-virtual {v4, v0, v7}, Landroid/support/v7/widget/an;->g(II)I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner;->g:Landroid/support/v7/widget/u;
