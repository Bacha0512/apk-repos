...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v0, p2, v1, p3, v7}, Landroid/support/v7/widget/an;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/an;

    move-result-object v1

    sget v0, Landroid/support/v7/a/a$j;->Toolbar_titleTextAppearance:I

    invoke-virtual {v1, v0, v7}, Landroid/support/v7/widget/an;->g(II)I
    ...
    invoke-virtual {v1, v0, v2}, Landroid/support/v7/widget/an;->c(II)I
    ...
    invoke-virtual {v1, v0, v7}, Landroid/support/v7/widget/an;->d(II)I
    ...
    invoke-virtual {v1, v2, v0}, Landroid/support/v7/widget/an;->d(II)I
    ...
    invoke-virtual {v1, v0, v6}, Landroid/support/v7/widget/an;->d(II)I
    ...
    invoke-virtual {v1, v0, v6}, Landroid/support/v7/widget/an;->e(II)I
    ...
    invoke-virtual {v1, v0, v8}, Landroid/support/v7/widget/an;->d(II)I

    move-result v0

    sget v2, Landroid/support/v7/a/a$j;->Toolbar_contentInsetEnd:I

    invoke-virtual {v1, v2, v8}, Landroid/support/v7/widget/an;->d(II)I

    move-result v2

    sget v3, Landroid/support/v7/a/a$j;->Toolbar_contentInsetLeft:I

    invoke-virtual {v1, v3, v7}, Landroid/support/v7/widget/an;->e(II)I

    move-result v3

    sget v4, Landroid/support/v7/a/a$j;->Toolbar_contentInsetRight:I

    invoke-virtual {v1, v4, v7}, Landroid/support/v7/widget/an;->e(II)I
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/an;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/an;->c(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v1, v0, v6}, Landroid/support/v7/widget/an;->b(II)I
...
.method public getWrapper()Landroid/support/v7/widget/p;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/ao;
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/ao;-><init>(Landroid/support/v7/widget/Toolbar;Z)V

    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->I:Landroid/support/v7/widget/ao;
...
.method protected onMeasure(II)V
    ...
    invoke-static {v9, v1}, Landroid/support/v7/widget/ar;->a(II)I
    ...
    invoke-static {v9, v0}, Landroid/support/v7/widget/ar;->a(II)I
    ...
    invoke-static {v11, v0}, Landroid/support/v7/widget/ar;->a(II)I
    ...
    invoke-static {v11, v4}, Landroid/support/v7/widget/ar;->a(II)I
    ...
    invoke-static {v11, v2}, Landroid/support/v7/widget/ar;->a(II)I
...
.method public onRtlPropertiesChanged(I)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->u:Landroid/support/v7/widget/ad;
