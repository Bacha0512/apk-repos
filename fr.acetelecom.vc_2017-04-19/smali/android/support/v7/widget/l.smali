...
.method protected static a(Landroid/content/Context;Landroid/support/v7/widget/h;I)Landroid/support/v7/widget/al;
    .locals 3
    ...
    iput-boolean v2, v0, Landroid/support/v7/widget/al;->d:Z

    iput-object v1, v0, Landroid/support/v7/widget/al;->a:Landroid/content/res/ColorStateList;
...
.method a()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/l;->b:Landroid/support/v7/widget/al;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/l;->c:Landroid/support/v7/widget/al;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/l;->d:Landroid/support/v7/widget/al;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/l;->e:Landroid/support/v7/widget/al;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/l;->b:Landroid/support/v7/widget/al;

    invoke-virtual {p0, v1, v2}, Landroid/support/v7/widget/l;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/al;)V

    const/4 v1, 0x1

    aget-object v1, v0, v1

    iget-object v2, p0, Landroid/support/v7/widget/l;->c:Landroid/support/v7/widget/al;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/l;->d:Landroid/support/v7/widget/al;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/l;->e:Landroid/support/v7/widget/al;

    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/l;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/al;)V
...
.method a(Landroid/content/Context;I)V
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/an;->a(IZ)Z
...
.method final a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/al;)V
    .locals 1
    ...
    invoke-static {p1, p2, v0}, Landroid/support/v7/widget/h;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/al;[I)V
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v6, p1, v3, p2, v2}, Landroid/support/v7/widget/an;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/an;

    move-result-object v3

    sget v4, Landroid/support/v7/a/a$j;->AppCompatTextHelper_android_textAppearance:I

    invoke-virtual {v3, v4, v8}, Landroid/support/v7/widget/an;->g(II)I

    move-result v4

    sget v7, Landroid/support/v7/a/a$j;->AppCompatTextHelper_android_drawableLeft:I

    invoke-virtual {v3, v7}, Landroid/support/v7/widget/an;->g(I)Z
    ...
    invoke-virtual {v3, v7, v2}, Landroid/support/v7/widget/an;->g(II)I

    move-result v7

    invoke-static {v6, v0, v7}, Landroid/support/v7/widget/l;->a(Landroid/content/Context;Landroid/support/v7/widget/h;I)Landroid/support/v7/widget/al;

    move-result-object v7

    iput-object v7, p0, Landroid/support/v7/widget/l;->b:Landroid/support/v7/widget/al;
    ...
    iput-object v7, p0, Landroid/support/v7/widget/l;->c:Landroid/support/v7/widget/al;
    ...
    iput-object v7, p0, Landroid/support/v7/widget/l;->d:Landroid/support/v7/widget/al;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/l;->e:Landroid/support/v7/widget/al;
    ...
    invoke-static {v6, v4, v0}, Landroid/support/v7/widget/an;->a(Landroid/content/Context;I[I)Landroid/support/v7/widget/an;
    ...
    invoke-virtual {v8, v0}, Landroid/support/v7/widget/an;->g(I)Z
    ...
    invoke-virtual {v8, v0, v2}, Landroid/support/v7/widget/an;->a(IZ)Z
    ...
    invoke-virtual {v8, v4}, Landroid/support/v7/widget/an;->g(I)Z
    ...
    invoke-virtual {v8, v4}, Landroid/support/v7/widget/an;->e(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v8, v9}, Landroid/support/v7/widget/an;->g(I)Z
    ...
    invoke-virtual {v8, v5}, Landroid/support/v7/widget/an;->e(I)Landroid/content/res/ColorStateList;

    move-result-object v5

    :cond_4
    :goto_2
    invoke-virtual {v8}, Landroid/support/v7/widget/an;->a()V

    :goto_3
    sget-object v8, Landroid/support/v7/a/a$j;->TextAppearance:[I

    invoke-static {v6, p1, v8, p2, v2}, Landroid/support/v7/widget/an;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/an;
    ...
    invoke-virtual {v6, v8}, Landroid/support/v7/widget/an;->g(I)Z
    ...
    invoke-virtual {v6, v1}, Landroid/support/v7/widget/an;->e(I)Landroid/content/res/ColorStateList;
