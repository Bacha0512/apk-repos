...
.method public a(Landroid/view/View;)V
    ...
    iget-object v0, v0, Landroid/support/v7/widget/LinearLayoutManager;->j:Landroid/support/v7/widget/aa;
    ...
    iget-object v1, v1, Landroid/support/v7/widget/LinearLayoutManager;->j:Landroid/support/v7/widget/aa;
    ...
    invoke-virtual {v1, p1}, Landroid/support/v7/widget/aa;->b(Landroid/view/View;)I
    ...
    iget-object v2, v2, Landroid/support/v7/widget/LinearLayoutManager;->j:Landroid/support/v7/widget/aa;
    ...
    iget-object v3, v3, Landroid/support/v7/widget/LinearLayoutManager;->j:Landroid/support/v7/widget/aa;

    invoke-virtual {v3, p1}, Landroid/support/v7/widget/aa;->a(Landroid/view/View;)I
    ...
    invoke-virtual {v1, p1}, Landroid/support/v7/widget/aa;->a(Landroid/view/View;)I
    ...
    invoke-virtual {v3, p1}, Landroid/support/v7/widget/aa;->e(Landroid/view/View;)I
    ...
    invoke-virtual {v3, p1}, Landroid/support/v7/widget/aa;->b(Landroid/view/View;)I
...
.method public b(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/aa;->b(Landroid/view/View;)I
    ...
    invoke-virtual {v1}, Landroid/support/v7/widget/aa;->b()I
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/aa;->a(Landroid/view/View;)I
