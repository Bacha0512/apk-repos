...
.method public a(Landroid/support/v7/widget/v$b;Landroid/support/v7/widget/v$b;)I
    ...
    iget-object v0, p1, Landroid/support/v7/widget/v$b;->d:Landroid/support/v7/widget/RecyclerView;
    ...
    :goto_0
    iget-object v4, p2, Landroid/support/v7/widget/v$b;->d:Landroid/support/v7/widget/RecyclerView;
    ...
    iget-boolean v4, p2, Landroid/support/v7/widget/v$b;->a:Z
    ...
    :cond_6
    iget v0, p2, Landroid/support/v7/widget/v$b;->b:I

    iget v1, p1, Landroid/support/v7/widget/v$b;->b:I

    sub-int v1, v0, v1

    if-nez v1, :cond_0

    iget v0, p1, Landroid/support/v7/widget/v$b;->c:I

    iget v1, p2, Landroid/support/v7/widget/v$b;->c:I
