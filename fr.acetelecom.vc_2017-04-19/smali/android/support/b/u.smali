...
.method public static a(Landroid/view/ViewGroup;Landroid/support/b/y;)V
    ...
    :cond_0
    invoke-virtual {p1}, Landroid/support/b/y;->h()Landroid/support/b/y;

    move-result-object v0

    invoke-static {p0, v0}, Landroid/support/b/u;->c(Landroid/view/ViewGroup;Landroid/support/b/y;)V

    const/4 v1, 0x0

    invoke-static {p0, v1}, Landroid/support/b/m;->a(Landroid/view/View;Landroid/support/b/m;)V

    invoke-static {p0, v0}, Landroid/support/b/u;->b(Landroid/view/ViewGroup;Landroid/support/b/y;)V

    :cond_1
    return-void
.end method

.method private static b(Landroid/view/ViewGroup;Landroid/support/b/y;)V
    .locals 2
    ...
    invoke-direct {v0, p1, p0}, Landroid/support/b/u$a;-><init>(Landroid/support/b/y;Landroid/view/ViewGroup;)V
...
.method private static c(Landroid/view/ViewGroup;Landroid/support/b/y;)V
    .locals 2

    invoke-static {}, Landroid/support/b/u;->a()Landroid/support/v4/util/ArrayMap;
    ...
    invoke-virtual {p1, p0, v0}, Landroid/support/b/y;->a(Landroid/view/ViewGroup;Z)V
    ...
    invoke-virtual {v0}, Landroid/support/b/m;->a()V
