...
# direct methods
.method constructor <init>(Lcom/digits/sdk/android/n;Landroid/content/Context;Lcom/digits/sdk/android/an;Landroid/content/Context;)V
    .locals 0
...
.method public a(Lcom/twitter/sdk/android/core/i;)V
    ...
    iget-object v0, v0, Lcom/digits/sdk/android/n;->h:Lcom/digits/sdk/android/ar;
    ...
    invoke-virtual {v0, v1}, Lcom/digits/sdk/android/ar;->m(Lcom/digits/sdk/android/a/f;)V
    ...
    invoke-static {p1, v0}, Lcom/digits/sdk/android/aw;->a(Lcom/twitter/sdk/android/core/i;Ljava/lang/String;)Lcom/digits/sdk/android/aw;

    move-result-object v0

    iget-object v1, p0, Lcom/digits/sdk/android/n$1;->b:Lcom/digits/sdk/android/n;

    iget-object v1, v1, Lcom/digits/sdk/android/n;->g:Lcom/twitter/sdk/android/core/k;

    invoke-interface {v1, v0}, Lcom/twitter/sdk/android/core/k;->a(Lcom/twitter/sdk/android/core/j;)V

    iget-object v1, p0, Lcom/digits/sdk/android/n$1;->b:Lcom/digits/sdk/android/n;

    invoke-static {v1}, Lcom/digits/sdk/android/n;->b(Lcom/digits/sdk/android/n;)Ljava/lang/Boolean;
    ...
    invoke-virtual {v0, v1, v2, v3}, Lcom/digits/sdk/android/n;->a(Landroid/content/Context;Ljava/lang/String;Lcom/digits/sdk/android/internal/DigitsEventDetailsBuilder;)V
    ...
    iget-object v2, p0, Lcom/digits/sdk/android/n$1;->a:Landroid/content/Context;

    iget-object v3, p0, Lcom/digits/sdk/android/n$1;->b:Lcom/digits/sdk/android/n;

    invoke-static {v3}, Lcom/digits/sdk/android/n;->a(Lcom/digits/sdk/android/n;)Ljava/lang/String;

    move-result-object v3

    iget-object v4, p0, Lcom/digits/sdk/android/n$1;->b:Lcom/digits/sdk/android/n;

    iget-object v4, v4, Lcom/digits/sdk/android/n;->i:Lcom/digits/sdk/android/internal/DigitsEventDetailsBuilder;

    invoke-virtual {v1, v2, v0, v3, v4}, Lcom/digits/sdk/android/n;->a(Landroid/content/Context;Lcom/digits/sdk/android/aw;Ljava/lang/String;Lcom/digits/sdk/android/internal/DigitsEventDetailsBuilder;)V
