...
.method public onReceivedSslError(Landroid/webkit/WebView;Landroid/webkit/SslErrorHandler;Landroid/a/a/b;)V
    .locals 4

    const/4 v3, 0x0

    invoke-super {p0, p1, p2, p3}, Landroid/webkit/WebViewClient;->onReceivedSslError(Landroid/webkit/WebView;Landroid/webkit/SslErrorHandler;Landroid/a/a/b;)V

    iget-object v0, p0, Lcom/twitter/sdk/android/core/identity/f;->b:Lcom/twitter/sdk/android/core/identity/f$a;

    new-instance v1, Lcom/twitter/sdk/android/core/identity/j;

    invoke-virtual {p3}, Landroid/a/a/b;->a()I
