...
.method public createAnimator(Landroid/view/ViewGroup;Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    iget-boolean v0, v0, Landroid/support/transition/ChangeBounds;->mReparent:Z
    ...
    .line 187
    new-instance v43, Landroid/support/transition/ChangeBounds$1;
    ...
    invoke-direct {v0, v1, v2}, Landroid/support/transition/ChangeBounds$1;-><init>(Landroid/support/transition/ChangeBounds;Landroid/view/ViewGroup;)V

    .line 213
    .local v43, "transitionListener":Landroid/support/transition/Transition$TransitionListener;
    move-object/from16 v0, p0
    ...
    .end local v43    # "transitionListener":Landroid/support/transition/Transition$TransitionListener;
    :cond_11
    const/16 v24, 0x0
    ...
    .line 265
    new-instance v43, Landroid/support/transition/ChangeBounds$2;
    ...
    invoke-direct {v0, v1, v2}, Landroid/support/transition/ChangeBounds$2;-><init>(Landroid/support/transition/ChangeBounds;Landroid/view/ViewGroup;)V

    .line 291
    .restart local v43    # "transitionListener":Landroid/support/transition/Transition$TransitionListener;
    move-object/from16 v0, p0
    ...
    .end local v43    # "transitionListener":Landroid/support/transition/Transition$TransitionListener;
    :cond_1d
    new-instance v46, Landroid/support/transition/ChangeBounds$3;

    move-object/from16 v0, v46

    move-object/from16 v1, p0

    invoke-direct {v0, v1}, Landroid/support/transition/ChangeBounds$3;-><init>(Landroid/support/transition/ChangeBounds;)V
    ...
    invoke-interface {v0, v8}, Landroid/support/transition/ViewOverlayImpl;->add(Landroid/graphics/drawable/Drawable;)V
    ...
    sget-object v47, Landroid/support/transition/ChangeBounds;->sRectEvaluator:Landroid/support/transition/RectEvaluator;
    ...
    .line 325
    .restart local v5    # "anim":Landroid/animation/ObjectAnimator;
    new-instance v46, Landroid/support/transition/ChangeBounds$4;
    ...
    invoke-direct {v0, v1, v2, v8, v3}, Landroid/support/transition/ChangeBounds$4;-><init>(Landroid/support/transition/ChangeBounds;Landroid/view/ViewGroup;Landroid/graphics/drawable/BitmapDrawable;Landroid/view/View;)V
