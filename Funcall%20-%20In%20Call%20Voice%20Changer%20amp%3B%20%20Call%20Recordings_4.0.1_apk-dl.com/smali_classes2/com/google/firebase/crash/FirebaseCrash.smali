...
.method private constructor <init>(Lcom/google/firebase/FirebaseApp;Ljava/util/concurrent/ExecutorService;)V
    ...
    iget-object v0, p0, Lcom/google/firebase/crash/FirebaseCrash;->zzbVZ:Lcom/google/firebase/FirebaseApp;

    invoke-virtual {v0}, Lcom/google/firebase/FirebaseApp;->getApplicationContext()Landroid/content/Context;

    move-result-object v0

    iput-object v0, p0, Lcom/google/firebase/crash/FirebaseCrash;->mContext:Landroid/content/Context;

    new-instance v0, Lcom/google/firebase/crash/FirebaseCrash$zzb;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/google/firebase/crash/FirebaseCrash$zzb;-><init>(Lcom/google/firebase/crash/zza;)V

    iput-object v0, p0, Lcom/google/firebase/crash/FirebaseCrash;->zzbXU:Lcom/google/firebase/crash/FirebaseCrash$zzb;
...
.method public static getInstance(Lcom/google/firebase/FirebaseApp;)Lcom/google/firebase/crash/FirebaseCrash;
    ...
    invoke-direct {v0, p0, v1}, Lcom/google/firebase/crash/FirebaseCrash;-><init>(Lcom/google/firebase/FirebaseApp;Ljava/util/concurrent/ExecutorService;)V

    new-instance v2, Lcom/google/firebase/crash/zzc;

    const/4 v1, 0x0

    invoke-direct {v2, p0, v1}, Lcom/google/firebase/crash/zzc;-><init>(Lcom/google/firebase/FirebaseApp;Ljava/lang/String;)V

    new-instance v1, Lcom/google/firebase/crash/FirebaseCrash$zzc;

    invoke-static {}, Ljava/lang/Thread;->getDefaultUncaughtExceptionHandler()Ljava/lang/Thread$UncaughtExceptionHandler;

    move-result-object v3

    invoke-direct {v1, v0, v3}, Lcom/google/firebase/crash/FirebaseCrash$zzc;-><init>(Lcom/google/firebase/crash/FirebaseCrash;Ljava/lang/Thread$UncaughtExceptionHandler;)V

    invoke-static {v1}, Ljava/lang/Thread;->setDefaultUncaughtExceptionHandler(Ljava/lang/Thread$UncaughtExceptionHandler;)V

    new-instance v6, Lcom/google/firebase/crash/zzb;

    invoke-direct {v6, v0}, Lcom/google/firebase/crash/zzb;-><init>(Lcom/google/firebase/crash/FirebaseCrash;)V
    ...
    invoke-direct {v1, v2}, Lcom/google/firebase/crash/zzd;-><init>(Lcom/google/firebase/crash/zzc;)V
    ...
    invoke-direct/range {v1 .. v6}, Lcom/google/firebase/crash/zze;-><init>(Lcom/google/firebase/crash/zzc;Ljava/util/concurrent/Future;JLcom/google/firebase/crash/zzf;)V
    ...
    new-instance v2, Lcom/google/firebase/crash/zza;

    invoke-direct {v2, v0}, Lcom/google/firebase/crash/zza;-><init>(Lcom/google/firebase/crash/FirebaseCrash;)V

    invoke-interface {v1, v2}, Ljava/util/concurrent/ExecutorService;->execute(Ljava/lang/Runnable;)V

    sput-object v0, Lcom/google/firebase/crash/FirebaseCrash;->zzbXS:Lcom/google/firebase/crash/FirebaseCrash;
...
.method private final zzFf()Z
    ...
    iget-object v1, p0, Lcom/google/firebase/crash/FirebaseCrash;->zzbXU:Lcom/google/firebase/crash/FirebaseCrash$zzb;

    invoke-virtual {v1}, Lcom/google/firebase/crash/FirebaseCrash$zzb;->zzFg()Lcom/google/android/gms/internal/mj;
...
.method final zza(Lcom/google/android/gms/internal/mj;)V
    ...
    iget-object v0, p0, Lcom/google/firebase/crash/FirebaseCrash;->zzbXW:Lcom/google/android/gms/internal/mp;
    ...
    iget-object v1, p0, Lcom/google/firebase/crash/FirebaseCrash;->mContext:Landroid/content/Context;

    iget-object v2, p0, Lcom/google/firebase/crash/FirebaseCrash;->zzbXT:Ljava/util/concurrent/ExecutorService;

    iget-object v3, p0, Lcom/google/firebase/crash/FirebaseCrash;->zzbXU:Lcom/google/firebase/crash/FirebaseCrash$zzb;

    invoke-virtual {v0, v1, v2, v3}, Lcom/google/android/gms/internal/mp;->zza(Landroid/content/Context;Ljava/util/concurrent/ExecutorService;Lcom/google/firebase/crash/FirebaseCrash$zza;)V
